...
# Define the CSV file to store model metrics
...
# ----- Evaluation -----
model_counter = 1  # To generate unique model names

for params in grid_search.cv_results_['params']:
    # Set hyperparameters for the model
    rf = RandomForestClassifier(random_state=42, class_weight="balanced", **params)

    model_name = f"candidate_model_{model_counter}_{params['n_estimators']}_{params['max_depth']}_{params['min_samples_split']}_{params['min_samples_leaf']}"
    ...
    for train_idx, test_idx in gkf.split(X_scaled, y, groups):
        ...
        rf_os = rf.fit(X_train_os, y_train_os)

        # Predictions & Probabilities
        y_pred_train = rf.predict(X_train)
        y_pred_test = rf.predict(X_test)
        y_pred_train_os = rf_os.predict(X_train_os)
