...
def build_layout(variable_options):
    return dbc.Container([
        ...
        dbc.Row([
            dbc.Col([
                html.H5("Missing Value Analysis – Total"),
                html.Div(id='summary-total')
            ], width=6),
            dbc.Col([
                html.H5("Missing Value Analysis – Current"),
        ...
        dbc.Row([
            dbc.Col([
                html.H5("Statistical Summary – Total"),
                html.Div(id='summary-total-numeric')
            ], width=6),
            dbc.Col([
                html.H5("Statistical Summary – Current"),
...
def register_callbacks(app, df, numeric_vars):
    ...
    def update_dashboard(variable):
        ...
        return (
            ...
            summary_table(missing_results["current_summary"], "Missing % (Current)"),
            summary_table(numeric_results["total_summary"], "Stats (Total)"),
            summary_table(numeric_results["current_summary"], "Stats (Current)"),
            line_plot(numeric_results["time_series"])
        )
